...
;(function () {
  ...
  function da(a) {
    ...
    E
      ? l(a.g.getElementsByClassName('wb-full')[0], 'click', function (b) {
          m(b)
          a.focus().fullscreen()
        })
      : a.addClass('no-full')
  ...
  function U(a, b) {
    function c(f) {
      ...
      if (a.min) a.minimize()
        ...
        a.max ||
          ...
          (p = f.touches) && (p = p[0])
            ? ((f = p), l(window, 'touchmove', e), l(window, 'touchend', d))
    ...
    function e(f) {
      ...
      if (K || u)
        K && (a.width = Math.max(Math.min(a.width, I - a.x - a.right), 150)),
          u &&
            (a.height = Math.max(Math.min(a.height, O - a.y - a.bottom), 35)),
          a.resize()
      if (A || w)
        A && (a.x = Math.max(Math.min(a.x, I - a.width - a.right), a.left)),
          w && (a.y = Math.max(Math.min(a.y, O - a.height - a.bottom), a.top)),
          a.move()
      J = z
      G = f
    }
  ...
  g.move = function (a, b, c) {
    a || 0 === a
      ? c ||
        ((this.x = a ? (a = S(a, I - this.left - this.right, this.width)) : 0),
        (this.y = b ? (b = S(b, O - this.top - this.bottom, this.height)) : 0))
      : ((a = this.x),
        (b = this.y),
        this.v &&
          (0 === a
