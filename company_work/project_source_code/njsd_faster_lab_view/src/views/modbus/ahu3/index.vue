<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="ahu3List" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="温度8 无探头" align="center" prop="temp8NoProbe" width="110"/>
      ...
      <el-table-column label="湿度4 无探头" align="center" prop="humidity4NoProbe" width="110"/>
      <el-table-column label="湿度5 无探头" align="center" prop="humidity5NoProbe" width="110"/>
      <el-table-column label="湿度6 无探头" align="center" prop="humidity6NoProbe" width="110"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="湿度4 无探头" prop="humidity4NoProbe">
          <el-input v-model="form.humidity4NoProbe" placeholder="请输入湿度4 无探头" />
        </el-form-item>
...
<script>
import { listAhu3, getAhu3, delAhu3, addAhu3, updateAhu3 } from "@/api/modbus/ahu3";
...
export default {
  ...
  data() {
    return {
      ...
      // 是否显示弹出层
      open: false,
      exportUrl: '/modbus/ahu3/export',
      exportName: 'ahu3_',
      modbusType: 'ModbusAhu3',
  ...
  methods: {
    ...
    getList() {
      ...
      listAhu3(this.queryParams).then(response => {
        this.ahu3List = response.rows;
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.rowId != null) {
            updateAhu3(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addAhu3(this.form).then(response => {
