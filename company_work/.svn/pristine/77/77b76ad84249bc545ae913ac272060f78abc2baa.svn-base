<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="ahu7List" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="系统启停状态" align="center" prop="systemStartStopStatus" /wwidth="100">
      ...
      <el-table-column label="温度6 无探头" align="center" prop="temp6NoProbe" width="100"/>
      <el-table-column label="温度7 无探头" align="center" prop="temp7NoProbe" width="100"/>
      ...
      <el-table-column label="湿度5 无探头" align="center" prop="humidity5NoProbe" width="100"/>
      <el-table-column label="湿度6 无探头" align="center" prop="humidity6NoProbe" width="100"/>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="温度6 无探头" prop="temp6NoProbe">
          <el-input v-model="form.temp6NoProbe" placeholder="请输入温度6 无探头" />
        </el-form-item>
        <el-form-item label="温度7 无探头" prop="temp7NoProbe">
          <el-input v-model="form.temp7NoProbe" placeholder="请输入温度7 无探头" />
        </el-form-item>
        ...
        <el-form-item label="湿度5 无探头" prop="humidity5NoProbe">
          <el-input v-model="form.humidity5NoProbe" placeholder="请输入湿度5 无探头" />
        </el-form-item>
        <el-form-item label="湿度6 无探头" prop="humidity6NoProbe">
          <el-input v-model="form.humidity6NoProbe" placeholder="请输入湿度6 无探头" />
        </el-form-item>
...
<script>
import { listAhu7, getAhu7, delAhu7, addAhu7, updateAhu7 } from "@/api/modbus/ahu7";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      listAhu7(this.queryParams).then(response => {
        this.ahu7List = response.rows;
    ...
    reset() {
      this.form = {
        ...
        humidity3: null,
        humidity4: null,
        humidity5NoProbe: null,
        humidity6NoProbe: null,
        tempAvg: null,
        humidityAvg: null,
      ...
      this.$refs["form"].validate(valid => {
        if (valid) {
          if (this.form.rowId != null) {
            updateAhu7(this.form).then(response => {
              this.$modal.msgSuccess("修改成功");
              this.open = false;
              this.getList();
            });
          } else {
            addAhu7(this.form).then(response => {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('/modbus/ahu7/export', {
        ...this.queryParams
      }, `ahu7_${new Date().getTime()}.xlsx`)
    },
    utcFormat(dateStr) {
