...
loader.load(
  '../models/control-system/Air_ConditioningSystemFlowChart_MAU_2_1/Air_ConditioningSystemFlowChart_AHU_2_1.FBX',
  function (obj) {
    ...
    addDataLabel('ModbusBms2f13')
    addtexturemove('PF_Wind', 0.5)
    obj.traverse(function (mesh) {
      if (
        mesh.isMesh &&
